...
namespace GeoApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "GeoApi", Version = "v1" });
            });
            ...
            services.AddDbContextPool<GeoIconsContext> (optionsAction: (provider, builder) => {
                ...
                builder.UseSqlServer(connectionString: "Data Source=(localdb)\\MSSQLLocalDB;Database=GeoIconsDb;Integrated Security=True;");
            });
